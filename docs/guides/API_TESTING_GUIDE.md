...
Primary namespace: `mullion-gallery/v1`
...
- Many admin routes require `manage_mullion` capability (admin-only). Public routes show `Public` below.
...
1) Campaigns
- GET /wp-json/mullion-gallery/v1/campaigns
...
- POST /wp-json/mullion-gallery/v1/campaigns
  - Auth: Admin (`manage_mullion` required)
...
- GET /wp-json/mullion-gallery/v1/campaigns/{id}
...
- PUT /wp-json/mullion-gallery/v1/campaigns/{id}
  - Auth: Admin
...
- GET /wp-json/mullion-gallery/v1/campaigns/{id}/media
...
- POST /wp-json/mullion-gallery/v1/campaigns/{id}/media
  - Auth: Admin
...
- PUT /wp-json/mullion-gallery/v1/campaigns/{id}/media/{mediaId}
  - Auth: Admin
  - Body: fields to update (title, caption, thumbnail, order)

- DELETE /wp-json/mullion-gallery/v1/campaigns/{id}/media/{mediaId}
  - Auth: Admin
  - Successful: 200 message or deleted payload

- PUT /wp-json/mullion-gallery/v1/campaigns/{id}/media/reorder
  - Auth: Admin
  - Body: `{ items: [ {id, order}, ... ] }` or similar (client uses `{items: [{id, order}]}`)

- POST /wp-json/mullion-gallery/v1/campaigns/{id}/media/rescan
  - Auth: Admin — triggers type rescan for campaign media

- POST /wp-json/mullion-gallery/v1/media/rescan-all
  - Auth: Admin — triggers global rescan; returns counts

- POST /wp-json/mullion-gallery/v1/media/upload
  - Auth: Admin
  - Used by upload helper; expects attachment/upload workflow (server-side handles attachments)

3) Media usage & library
- GET /wp-json/mullion-gallery/v1/media/{mediaId}/usage
  - Auth: Admin
  - Returns campaigns that reference `mediaId` { count, campaigns }

- GET /wp-json/mullion-gallery/v1/media/usage-summary?ids[]=id1&ids[]=id2...
  - Auth: Admin
  - Returns object map { mediaId: count }

- GET /wp-json/mullion-gallery/v1/media/library
  - Auth: Admin — returns global media library search/list

4) Access / Access Requests
- GET /wp-json/mullion-gallery/v1/campaigns/{id}/access
  - Auth: Admin — lists explicit access grants and overrides

- POST /wp-json/mullion-gallery/v1/campaigns/{id}/access
  - Auth: Admin
  - Body: { userId, source, action } (client uses specific shape)

- DELETE /wp-json/mullion-gallery/v1/campaigns/{id}/access/{userId}
  - Auth: Admin

- POST /wp-json/mullion-gallery/v1/campaigns/{id}/access-requests
  - Auth: Public (rate-limited)
  - Body: { email, name, message? } — submits an access request

- GET /wp-json/mullion-gallery/v1/campaigns/{id}/access-requests
  - Auth: Admin — list pending requests

- POST /wp-json/mullion-gallery/v1/campaigns/{id}/access-requests/{token}/approve
  - Auth: Admin

- POST /wp-json/mullion-gallery/v1/campaigns/{id}/access-requests/{token}/deny
  - Auth: Admin

5) Companies
- GET /wp-json/mullion-gallery/v1/companies
  - Auth: Admin

- GET /wp-json/mullion-gallery/v1/companies/{id}/access
  - Auth: Admin

- POST /wp-json/mullion-gallery/v1/companies/{id}/access
  - Auth: Admin

- DELETE /wp-json/mullion-gallery/v1/companies/{id}/access/{userId}
  - Auth: Admin

- POST /wp-json/mullion-gallery/v1/companies/{id}/archive
  - Auth: Admin

6) Users & Roles
- GET /wp-json/mullion-gallery/v1/users/search?search=term
  - Auth: Admin

- POST /wp-json/mullion-gallery/v1/users
...
8) OEmbed proxy
- GET /wp-json/mullion-gallery/v1/oembed?url={encoded-url}
  - Auth: Public (rate-limited)
...
9) Analytics
- POST /wp-json/mullion-gallery/v1/analytics/event
...
- GET /wp-json/mullion-gallery/v1/analytics/campaigns/{id}?from=YYYY-MM-DD&to=YYYY-MM-DD
  - Auth: Admin — returns totals and daily breakdown

10) Tags and Categories
- GET /wp-json/mullion-gallery/v1/campaign-categories
  - Auth: Admin — returns id, name, slug, count

- GET /wp-json/mullion-gallery/v1/tags/campaign
  - Auth: Admin

- GET /wp-json/mullion-gallery/v1/tags/media
  - Auth: Admin

11) Admin / Monitoring / Cache
- GET /wp-json/mullion-gallery/v1/admin/health
  - Auth: Admin — returns health diagnostics

- GET /wp-json/mullion-gallery/v1/admin/oembed-failures
  - Auth: Admin
- DELETE /wp-json/mullion-gallery/v1/admin/oembed-failures
  - Auth: Admin

- GET /wp-json/mullion-gallery/v1/admin/thumbnail-cache
  - Auth: Admin
- DELETE /wp-json/mullion-gallery/v1/admin/thumbnail-cache
  - Auth: Admin
- POST /wp-json/mullion-gallery/v1/admin/thumbnail-cache/refresh
  - Auth: Admin

12) Layout templates, overlays, fonts (admin)
- GET/POST /wp-json/mullion-gallery/v1/admin/layout-templates
- GET/PUT/DELETE /wp-json/mullion-gallery/v1/admin/layout-templates/{templateId}
- POST /wp-json/mullion-gallery/v1/admin/layout-templates/{templateId}/duplicate

- GET/POST /wp-json/mullion-gallery/v1/admin/overlay-library
- DELETE /wp-json/mullion-gallery/v1/admin/overlay-library/{id}

- GET/POST /wp-json/mullion-gallery/v1/admin/font-library
- DELETE /wp-json/mullion-gallery/v1/admin/font-library/{id}

13) Public layout template read
- GET /wp-json/mullion-gallery/v1/layout-templates/{templateId}
...
- Route registrations & server behavior: [wp-plugin/mullion-gallery/includes/class-mullion-rest.php](../../wp-plugin/mullion-gallery/includes/class-mullion-rest.php)
- Client usage/examples: `src/services/apiClient.ts`, `src/services/adminQuery.ts`, `src/contexts/AuthContext.tsx` and admin SPA builds under `wp-plugin/mullion-gallery/admin/build/assets`.

If you want, I can:
- Generate an OpenAPI / Postman collection from the PHP route registrations in `class-mullion-rest.php`.

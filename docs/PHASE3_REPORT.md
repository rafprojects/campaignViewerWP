...
- Manual QA in WP still required (upload/external add/edit/delete/reorder, access grant/revoke, campaign CRUD)

## Next Steps

- Run a manual QA pass in WP and note any UX edge cases.
- Prepare release packaging (verify plugin assets and version bump if needed).

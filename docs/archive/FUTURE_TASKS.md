...
| Spotlight / Hero adapter | Cleanest deferred adapter fit; current adapter contract supports it with bounded settings and normal registry delivery | [PHASE31_REPORT.md](../PHASE31_REPORT.md) |
| Vertical Scroll Snap adapter | Promoted after re-scoping from a raw full-viewport story UI to the current bounded gallery-section model | [PHASE31_REPORT.md](../PHASE31_REPORT.md) |
| Waterfall as Masonry enhancement | Better treated as a Masonry animation option than a standalone adapter family | [PHASE31_REPORT.md](../PHASE31_REPORT.md) |
| Media payload foundations for timeline/filter follow-ons | Defines canonical chronology, payload, and media-tag exposure boundaries before higher-risk gallery work | [PHASE31_REPORT.md](../PHASE31_REPORT.md) |
...
> **Origin:** Phase 8 brainstorm (P22). The remaining gallery ideas below stay deferred after promotion of Spotlight / Hero, section-bounded Vertical Scroll Snap, Waterfall-as-Masonry, and media payload foundations into [PHASE31_REPORT.md](../PHASE31_REPORT.md). Variable Aspect-Ratio Grid has been pruned as overlapping `justified`.
...
LOE: Medium | Impact: Low-Medium | Dependency: `P31-H` must define canonical chronology and payload shape first

### Isotope / Filterable Gallery Wrapper
Filtering and sorting above the adapter layer, with animated transitions for the visible set. Future work should be framed as a wrapper/orchestration surface rather than a new adapter id.
LOE: Medium-High | Impact: Medium
...
*Last updated: May 19, 2026 — Reconciled against current code and Phase 28 completions; removed shipped backlog items in two passes, moved promoted work fully into Phases 31–34, audited the remaining deferred review list, retired stale deferred entries (D-10, D-17, RD-4), and kept the rest as long-tail reference material.*

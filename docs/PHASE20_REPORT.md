...
- [Phase 20 — Production Hardening, CI Pipeline \& Distribution Readiness](#phase-20--production-hardening-ci-pipeline--distribution-readiness)
  ...
  - [Track P20-G — GitHub Actions CI/CD Pipeline](#track-p20-g--github-actions-cicd-pipeline)
    - [Problem](#problem-5)
    - [Decisions](#decisions)
    - [Versioning strategy](#versioning-strategy)
    - [Pipeline architecture](#pipeline-architecture)
      - [Workflow 1: `.github/workflows/ci.yml` — Every push/PR](#workflow-1-githubworkflowsciyml--every-pushpr)
      - [Workflow 2: `.github/workflows/release.yml` — Manual trigger](#workflow-2-githubworkflowsreleaseyml--manual-trigger)
      - [Workflow 3: `.github/workflows/svn-deploy.yml` — Deploy existing release to WordPress.org](#workflow-3-githubworkflowssvn-deployyml--deploy-existing-release-to-wordpressorg)
      - [Workflow 4: `.github/workflows/e2e.yml` — Manual E2E testing](#workflow-4-githubworkflowse2eyml--manual-e2e-testing)

...
vi.mock('@/components/Campaign/Lightbox', () => ({
  Lightbox: ({ isOpen }: { isOpen: boolean }) =>
    isOpen ? <div data-testid="lightbox-open" /> : null,
}));

vi.mock('@/components/Gallery/LazyImage', () => ({
...
const { CircularGallery } = await import('@/gallery-adapters/circular/CircularGallery');
const { CompactGridGallery } = await import('@/gallery-adapters/compact-grid/CompactGridGallery');
const { DiamondGallery } = await import('@/gallery-adapters/diamond/DiamondGallery');
const { HexagonalGallery } = await import('@/gallery-adapters/hexagonal/HexagonalGallery');
const { JustifiedGallery } = await import('@/gallery-adapters/justified/JustifiedGallery');
const { MasonryGallery } = await import('@/gallery-adapters/masonry/MasonryGallery');

...
export const DEFAULT_GALLERY_BEHAVIOR_SETTINGS: GalleryBehaviorSettings = {
  ...
  imageBgType: 'none',
  imageBgColor: '#102530',
  imageBgGradient: 'linear-gradient(135deg, #102530 0%, #08141b 100%)',
  imageBgImageUrl: '',
  videoBgType: 'none',
  videoBgColor: '#08141b',
  videoBgGradient: 'linear-gradient(135deg, #08141b 0%, #102530 100%)',
  videoBgImageUrl: '',
  unifiedBgType: 'none',
  unifiedBgColor: '#102530',
  unifiedBgGradient: 'linear-gradient(135deg, #102530 0%, #08141b 100%)',
  unifiedBgImageUrl: '',
  // P13-A: Campaign Card settings
  cardBorderRadius: 8,

...
function ResetLink({ fieldKey, unitKey, hasOverride, onReset }: ResetLinkProps) {
        ...
        <Accordion.Panel>
          <Stack gap="md">
            <DimensionInput
              ...
              step={1}
            />
            <ResetLink fieldKey="cardBorderRadius" unitKey="cardBorderRadiusUnit" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              step={1}
            />
            <ResetLink fieldKey="cardBorderWidth" hasOverride={hasOverride} onReset={handleReset} />
            <ModalSelect
            ...
            />
            <ResetLink fieldKey="cardBorderMode" hasOverride={hasOverride} onReset={handleReset} />
            ...
            {resolvedBorderMode === 'single' && <ResetLink fieldKey="cardBorderColor" hasOverride={hasOverride} onReset={handleReset} />}
            <ModalSelect
            ...
            />
            <ResetLink fieldKey="cardShadowPreset" hasOverride={hasOverride} onReset={handleReset} />
            <DimensionInput
              ...
              step={10}
            />
            <ResetLink fieldKey="cardThumbnailHeight" unitKey="cardThumbnailHeightUnit" hasOverride={hasOverride} onReset={handleReset} />
            <ModalSelect
            ...
            />
            <ResetLink fieldKey="cardThumbnailFit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="showCardCompanyName" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardAccessBadge" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardTitle" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardDescription" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardMediaCounts" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardBorder" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardThumbnailFade" hasOverride={hasOverride} onReset={handleReset} />
            <Switch
            ...
            />
            <ResetLink fieldKey="showCardInfoPanel" hasOverride={hasOverride} onReset={handleReset} />
          </Stack>
        </Accordion.Panel>
      </Accordion.Item>
      ...
      <Accordion.Item value="grid-pagination">
        ...
        <Accordion.Panel>
          <Stack gap="md">
            ...
            />
            <ResetLink fieldKey="cardGridColumns" hasOverride={hasOverride} onReset={handleReset} />
            ...
            {resolved.cardGridColumns === 0 && (
              <>
                <NumberInput
                  ...
                  max={8}
                />
                <ResetLink fieldKey="cardMaxColumns" hasOverride={hasOverride} onReset={handleReset} />
              </>
            )}
            ...
            <DimensionInput
              ...
              step={2}
            />
            <ResetLink fieldKey="cardGapH" unitKey="cardGapHUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <DimensionInput
              ...
              step={2}
            />
            <ResetLink fieldKey="cardGapV" unitKey="cardGapVUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardMaxWidth" unitKey="cardMaxWidthUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <NumberInput
              ...
              decimalScale={2}
            />
            <ResetLink fieldKey="cardScale" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardJustifyContent" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardGalleryVerticalAlign" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardGalleryMinHeight" unitKey="cardGalleryMinHeightUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardGalleryMaxHeight" unitKey="cardGalleryMaxHeightUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <DimensionInput
              ...
              allowNegative
            />
            <ResetLink fieldKey="cardGalleryOffsetX" unitKey="cardGalleryOffsetXUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <DimensionInput
              ...
              allowNegative
            />
            <ResetLink fieldKey="cardGalleryOffsetY" unitKey="cardGalleryOffsetYUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardAspectRatio" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <DimensionInput
              ...
              step={10}
            />
            <ResetLink fieldKey="cardMinHeight" unitKey="cardMinHeightUnit" hasOverride={hasOverride} onReset={handleReset} />
            ...
            />
            <ResetLink fieldKey="cardDisplayMode" hasOverride={hasOverride} onReset={handleReset} />
            ...
            {resolved.cardDisplayMode === 'paginated' && (
              <>
                <NumberInput
                  ...
                  step={1}
                />
                <ResetLink fieldKey="cardRowsPerPage" hasOverride={hasOverride} onReset={handleReset} />
                <Switch
                ...
                />
                <ResetLink fieldKey="cardPageDotNav" hasOverride={hasOverride} onReset={handleReset} />
                <NumberInput
                  ...
                  step={50}
                />
                <ResetLink fieldKey="cardPageTransitionMs" hasOverride={hasOverride} onReset={handleReset} />
              </>
            )}
          </Stack>
        </Accordion.Panel>
      ...
      <Accordion.Item value="card-internals">
        ...
        <Accordion.Panel>
          <Stack gap="md">
            ...
            />
            <ResetLink fieldKey="cardLockedOpacity" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <Slider
              ...
              step={0.05}
            />
            <ResetLink fieldKey="cardGradientStartOpacity" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <Slider
              ...
              step={0.05}
            />
            <ResetLink fieldKey="cardGradientEndOpacity" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              max={64}
            />
            <ResetLink fieldKey="cardLockIconSize" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              max={32}
            />
            <ResetLink fieldKey="cardAccessIconSize" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              max={32}
            />
            <ResetLink fieldKey="cardBadgeOffsetY" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              max={400}
            />
            <ResetLink fieldKey="cardCompanyBadgeMaxWidth" hasOverride={hasOverride} onReset={handleReset} />
            <NumberInput
              ...
              max={1000}
            />
            <ResetLink fieldKey="cardThumbnailHoverTransitionMs" hasOverride={hasOverride} onReset={handleReset} />
            ...
            <Slider
              ...
              step={0.05}
            />
            <ResetLink fieldKey="cardPageTransitionOpacity" hasOverride={hasOverride} onReset={handleReset} />
            <TextInput
            ...
            />
            <ResetLink fieldKey="cardAutoColumnsBreakpoints" hasOverride={hasOverride} onReset={handleReset} />
          </Stack>
        </Accordion.Panel>
      </Accordion.Item>

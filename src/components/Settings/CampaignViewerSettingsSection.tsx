...
export function CampaignViewerSettingsSection({ settings, updateSetting }: CampaignViewerSettingsSectionProps) {
  ...
  const galleryVideoLabel = getRepresentativeGalleryCommonSetting(resolvedGalleryConfig, 'galleryVideoLabel') as string | undefined;
  const galleryLabelJustification = getRepresentativeGalleryCommonSetting(resolvedGalleryConfig, 'galleryLabelJustification') as GalleryBehaviorSettings['galleryLabelJustification'] | undefined;
  const showGalleryLabelIcon = getRepresentativeGalleryCommonSetting(resolvedGalleryConfig, 'showGalleryLabelIcon') as boolean | undefined;

  const updateViewerCommonSetting = (
    key: Extract<
      keyof GalleryCommonSettings,
      'showCampaignGalleryLabels' | 'galleryImageLabel' | 'galleryVideoLabel' | 'galleryLabelJustification' | 'showGalleryLabelIcon'
    >,

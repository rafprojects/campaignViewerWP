...
/**
 * Standalone mount for the WP-admin "Gallery Spaces" page (#mullion-spaces-admin).
 *
 ...
 * window.__MULLION_CONFIG__ by the HTTP transport), so no JWT flow is required for a

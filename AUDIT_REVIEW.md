...
### Track M9-C - Shadow DOM, Portals, and Overlays
**Current Evidence:**
The codebase heavily uses custom shadow DOM integration, portals, and explicit z-index management, exactly as described in the audit:
...
**Findings:**
This is a critical area for the migration. The audit is spot-on about the complexity here - this repo is heavily invested in shadow DOM CSS scoping, portals, and overlay behavior, making it a high QA-risk area. The current implementation is actually more complex than what's described in the audit.

 ...
 */
class Mullion_Settings_Registry {
    ...
    private static $defaults = [
        ...
        'tile_glow_color'            => '#1ad1c4',
        'tile_glow_spread'           => 12,
        'tile_hover_bounce'          => true,
        'masonry_columns'            => 0,
        'image_bg_type'              => 'none',
        'image_bg_color'             => '#102530',
        'image_bg_gradient'          => 'linear-gradient(135deg, #102530 0%, #08141b 100%)',
        'image_bg_image_url'         => '',
        'video_bg_type'              => 'none',
        'video_bg_color'             => '#08141b',
        'video_bg_gradient'          => 'linear-gradient(135deg, #08141b 0%, #102530 100%)',
        'video_bg_image_url'         => '',
        'unified_bg_type'            => 'none',
        'unified_bg_color'           => '#102530',
        'unified_bg_gradient'        => 'linear-gradient(135deg, #102530 0%, #08141b 100%)',
        'unified_bg_image_url'       => '',
        'card_border_radius'         => 8,
        'card_border_width'          => 4,
        'card_border_mode'           => 'auto',
        'card_border_color'          => '#1ad1c4',
    ...
    public static function get_defaults() {
        ...
        if (defined('MULLION_DEBUG_COMPONENT_MARKERS')) {
            $defaults['debug_component_markers'] = (bool) MULLION_DEBUG_COMPONENT_MARKERS;
        }

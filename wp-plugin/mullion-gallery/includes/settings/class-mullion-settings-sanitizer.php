...
class Mullion_Settings_Sanitizer {
    ...
    public static function sanitize_settings($input, $defaults, $valid_options, $field_ranges) {
        ...
        $current_settings = get_option(Mullion_Settings::OPTION_NAME, []);
        ...
        // Mullion_Settings_Registry::$valid_options and ::$field_ranges. Adding such a
    ...
    private static function get_valid_gallery_adapters() {
        return class_exists('Mullion_CPT') ? Mullion_CPT::VALID_ADAPTERS
    ...
    private static function sanitize_nested_gallery_payload($raw, $default, $fallback_mode, $allow_empty_result) {
        ...
        $field_ranges = Mullion_Settings_Registry::get_field_ranges();
        $sanitized = [];

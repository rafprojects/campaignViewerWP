...
class Mullion_CPT {
    const POST_TYPE = 'mullion_campaign';
    ...
    public static function register() {
        ...
        if (is_admin()) {
            add_filter('manage_mullion_campaign_posts_columns', [self::class, 'add_space_column']);
            add_action('manage_mullion_campaign_posts_custom_column', [self::class, 'render_space_column'], 10, 2);
            ...
            add_filter('manage_edit-mullion_company_columns', [self::class, 'rename_company_count_column']);
        }

        register_post_type(self::POST_TYPE, [
            // P51-G: rename the top-level WP menu to "Mullion" (menu_name)
            ...
            'labels' => [
                ...
                'menu_name'          => __('Mullion', 'mullion-gallery'),
            ...
            'capability_type' => ['mullion_campaign', 'mullion_campaigns'],
            'map_meta_cap' => true,
        ]);

        register_taxonomy('mullion_company', self::POST_TYPE, [
        ...
        register_taxonomy('mullion_campaign_tag', self::POST_TYPE, [
        ...
        register_taxonomy('mullion_campaign_category', self::POST_TYPE, [
        ...
        register_taxonomy('mullion_media_tag', 'attachment', [
        ...
        register_post_type('mullion_layout_tpl', [
        ...
        register_term_meta('mullion_company', 'access_grants', [
            'type' => 'array',
            'single' => true,
            'show_in_rest' => false,
            'default' => [],
    ...
    public static function render_space_column(string $column, int $post_id): void {
        ...
        $space = class_exists('Mullion_DB') ? Mullion_DB::get_space($space_id) : null;

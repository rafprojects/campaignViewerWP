 ...
 *
 * This class now delegates to the modular Mullion_Provider_Registry.
 * The public fetch() method is preserved for backwards compatibility
 * with existing call sites (e.g. class-mullion-rest.php::proxy_oembed).
 *
...
require_once __DIR__ . '/providers/class-mullion-provider-registry.php';

class Mullion_OEmbed_Providers {
    /**
    ...
    public static function fetch($url, $parsed, &$attempts) {
        return Mullion_Provider_Registry::resolve($url, $parsed, $attempts);
    }
}

 ...
 * (Mullion_Settings_Renderer, Mullion_Settings_Core_Fields, Mullion_Settings_Service) and
 * are NOT proxied through this class.
 */
class Mullion_Settings {
     ...
     */
    const GOOGLE_FONT_NAMES = Mullion_Settings_Typography::GOOGLE_FONT_NAMES;
     ...
     */
    const GOOGLE_FONT_SPECS = Mullion_Settings_Typography::GOOGLE_FONT_SPECS;
    ...
    private static function load_registry() {
        ...
        self::$defaults          = Mullion_Settings_Registry::get_defaults();
        self::$admin_only_fields = Mullion_Settings_Registry::get_admin_only_fields();
        self::$valid_options     = Mullion_Settings_Registry::get_valid_options();
        self::$field_ranges      = Mullion_Settings_Registry::get_field_ranges();
    ...
    public static function get_settings() {
        ...
        $settings = Mullion_Settings_Sanitizer::normalize_card_config_settings(
        ...
        return Mullion_Settings_Utils::strip_nested_only_gallery_legacy_fields($settings);
    }
    ...
    public static function sanitize_settings($input) {
        self::load_registry();
        return Mullion_Settings_Sanitizer::sanitize_settings(
            $input,
            self::$defaults,
            self::$valid_options,
            self::$field_ranges
    ...
    public static function to_js($settings, $admin = false) {
        self::load_registry();
        return Mullion_Settings_Utils::to_js($settings, self::$defaults, self::$admin_only_fields, $admin);
    }
    ...
    public static function from_js($body) {
        self::load_registry();
        return Mullion_Settings_Utils::from_js($body, self::$defaults);
    }
        ...
        foreach ($input as $key => $value) {
            ...
            if (is_bool($default)) {
                ...
                if ($key === 'viewer_bg_gradient') {
                    $sanitized[$key] = Mullion_Settings_Sanitizer::sanitize_viewer_bg_gradient($value);
                } else {
                ...
                if ($key === 'typography_overrides') {
                    ...
                    $sanitized[$key] = Mullion_Settings_Sanitizer::sanitize_typography_overrides($value);
    ...
    public static function get_overridable_keys(): array {
        return Mullion_Settings_Registry::get_space_overridable_fields();
    }

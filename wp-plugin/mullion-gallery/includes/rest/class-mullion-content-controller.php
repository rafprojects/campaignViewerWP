...
class Mullion_Content_Controller extends Mullion_REST_Base {
    ...
    public static function register_routes(): void {
        ...
        register_rest_route('wp-super-gallery/v1', '/campaign-categories', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('categories.list'),
            ],
            [
                'methods'             => 'POST',
                'callback'            => [self::class, 'create_campaign_category'],
                'permission_callback' => Mullion_Permissions::gate('categories.create'),
                'args'                => [
                    'name' => [
                        'required'          => true,
                        'type'              => 'string',
        ...
        register_rest_route('wp-super-gallery/v1', '/campaign-categories/(?P<id>\d+)', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('categories.update'),
                'args'                => [
                    'name' => [
                        'type'              => 'string',
                        'sanitize_callback' => 'sanitize_text_field',
            ...
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('categories.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/campaign-templates', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('campaign_templates.list'),
            ],
            [
                'methods'             => 'POST',
                'callback'            => [self::class, 'create_campaign_template'],
                'permission_callback' => Mullion_Permissions::gate('campaign_templates.create'),
                'args'                => [
                    'name' => [
                        'required'          => true,
                        'type'              => 'string',
        ...
        register_rest_route('wp-super-gallery/v1', '/campaign-templates/(?P<id>[a-zA-Z0-9_]+)', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('campaign_templates.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/campaign-templates/(?P<id>[a-zA-Z0-9_]+)/instantiate', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('campaign_templates.instantiate'),
                'args'                => [
                    'name' => [
                        'required'          => true,
                        'type'              => 'string',
        ...
        register_rest_route('wp-super-gallery/v1', '/companies', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('companies.list'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/tags/campaign', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('campaign_tags.list'),
            ],
            [
                'methods' => 'POST',
                'callback' => [self::class, 'create_campaign_tag'],
                'permission_callback' => Mullion_Permissions::gate('campaign_tags.create'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/tags/campaign/(?P<id>\d+)', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('campaign_tags.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/layout-templates', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('layout_templates.list'),
            ],
            [
                'methods' => 'POST',
                'callback' => [self::class, 'create_layout_template'],
                'permission_callback' => Mullion_Permissions::gate('layout_templates.create'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/layout-templates/(?P<templateId>[a-f0-9\-]{36})', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('layout_templates.read'),
            ],
            [
                'methods' => 'PUT',
                'callback' => [self::class, 'update_layout_template'],
                'permission_callback' => Mullion_Permissions::gate('layout_templates.update'),
            ],
            [
                'methods' => 'DELETE',
                'callback' => [self::class, 'delete_layout_template'],
                'permission_callback' => Mullion_Permissions::gate('layout_templates.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/layout-templates/(?P<templateId>[a-f0-9\-]{36})/duplicate', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('layout_templates.duplicate'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/asset-library', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('assets.list'),
            ],
            [
                'methods'             => 'POST',
                'callback'            => [self::class, 'upload_asset'],
                'permission_callback' => Mullion_Permissions::gate('assets.upload'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/asset-library/(?P<id>[a-f0-9\-]{36})', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('assets.update'),
            ],
            [
                'methods'             => 'DELETE',
                'callback'            => [self::class, 'delete_asset'],
                'permission_callback' => Mullion_Permissions::gate('assets.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/font-library', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('fonts.list'),
            ],
            [
                'methods'             => 'POST',
                'callback'            => [self::class, 'upload_font'],
                'permission_callback' => Mullion_Permissions::gate('fonts.upload'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/admin/font-library/(?P<id>[a-f0-9\-]{36})', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('fonts.update'),
            ],
            [
                'methods'             => 'DELETE',
                'callback'            => [self::class, 'delete_font'],
                'permission_callback' => Mullion_Permissions::gate('fonts.delete'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/layout-templates/(?P<templateId>[a-f0-9\-]{36})', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('layout_templates.read_public'),
            ],
        ]);
    }
    ...
    public static function list_campaign_templates($request) {
        $builtins = Mullion_Campaign_Templates::get_builtins();
        $user     = Mullion_Campaign_Templates::get_user_templates();
    ...
    public static function create_campaign_template($request) {
        ...
        return new WP_REST_Response(Mullion_Campaign_Templates::post_to_template($post), 201);
    }
    ...
    public static function instantiate_campaign_template($request) {
        ...
        if (Mullion_Campaign_Templates::is_builtin($id)) {
            $tpl = Mullion_Campaign_Templates::get_builtin($id);
        } else {
            $post_id = intval($id);
            $post    = get_post($post_id);
    ...
    public static function list_layout_templates($request) {
        $templates = Mullion_Layout_Templates::get_all();
    ...
    public static function create_layout_template($request) {
        ...
        $result = Mullion_Layout_Templates::create($data);
    ...
    public static function update_layout_template($request) {
        $id     = $request->get_param('templateId');
        $data   = $request->get_json_params();
        $result = Mullion_Layout_Templates::update($id, $data);
    ...
    public static function duplicate_layout_template($request) {
        ...
        $result   = Mullion_Layout_Templates::duplicate($id, $new_name);
    ...
    private static function filter_library_for_space( array $items, $request, string $asset_type ): array {
        ...
        $allowed = array_flip( Mullion_DB::get_space_library_assets( $space_id, $asset_type ) );
    ...
    public static function list_asset_library( $request ) {
        $items = Mullion_Asset_Library::get_all();
    ...
    public static function list_font_library( $request ) {
        $items = Mullion_Font_Library::get_all();
    ...
    public static function upload_font( $request ) {
        ...
        $entry = Mullion_Font_Library::add( [
            'url'          => $result['url'],
            'name'         => $name,
    ...
    public static function list_companies($request) {
        ...
        if (class_exists('Mullion_Settings')) {
            $ttl = intval(Mullion_Settings::get_setting('cache_ttl') ?: 300);
        }

...
class Mullion_Analytics_Controller extends Mullion_REST_Base {
    ...
    public static function register_routes(): void {
        ...
        register_rest_route('wp-super-gallery/v1', '/analytics/event', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('analytics.event.record'),
                'args'                => [
                    'campaign_id' => [
                        'required' => true,
                        'type'     => 'integer',
        ...
        register_rest_route('wp-super-gallery/v1', '/analytics/campaigns/(?P<id>\d+)', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('analytics.campaign.read'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/analytics/campaigns/(?P<id>\d+)/media', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('analytics.campaign.media.read'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/analytics/summary', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('analytics.summary.read'),
            ],
        ]);
    }

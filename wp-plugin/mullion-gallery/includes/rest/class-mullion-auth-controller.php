...
class Mullion_Auth_Controller extends Mullion_REST_Base {
    ...
    public static function register_routes(): void {
        register_rest_route('wp-super-gallery/v1', '/permissions', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('auth.permissions.read'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/nonce', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('auth.nonce.refresh'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/auth/login', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('auth.login'),
                'args'                => [
                    'username' => [
                        'required'          => true,
                        'type'              => 'string',
        ...
        register_rest_route('wp-super-gallery/v1', '/auth/logout', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('auth.logout'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/users/search', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('users.search'),
            ],
        ]);
        ...
        register_rest_route('wp-super-gallery/v1', '/users', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('users.create'),
                'args'                => [
                    'email'       => [
                        'required'          => true,
                        'type'              => 'string',
        ...
        register_rest_route('wp-super-gallery/v1', '/roles', [
            [
                ...
                'permission_callback' => Mullion_Permissions::gate('roles.list'),
            ],
        ]);
    }
    ...
    public static function handle_cookie_login($request) {
        ...
        $origin_host  = isset($_SERVER['HTTP_ORIGIN'])  ? wp_parse_url(sanitize_text_field(wp_unslash($_SERVER['HTTP_ORIGIN'])),  PHP_URL_HOST) : null;
        $referer_host = isset($_SERVER['HTTP_REFERER']) ? wp_parse_url(sanitize_text_field(wp_unslash($_SERVER['HTTP_REFERER'])), PHP_URL_HOST) : null;

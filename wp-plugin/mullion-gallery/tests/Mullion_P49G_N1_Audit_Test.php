...
class Mullion_P49G_N1_Audit_Test extends WP_UnitTestCase {
    ...
    public function test_returns_all_matching_campaigns_n10(): void {
        ...
        $result = Mullion_DB::get_campaigns_for_attachment_id(self::ATTACHMENT_ID);
    ...
    public function test_returns_empty_for_unknown_attachment(): void {
        ...
        $result = Mullion_DB::get_campaigns_for_attachment_id(999999);
    ...
    public function test_query_bound_n10(): void {
        ...
        Mullion_DB::get_campaigns_for_attachment_id(self::ATTACHMENT_ID);
    ...
    public function test_warning_fires_at_n100(): void {
        ...
        $this->setExpectedIncorrectUsage('Mullion_DB::get_campaigns_for_attachment_id');

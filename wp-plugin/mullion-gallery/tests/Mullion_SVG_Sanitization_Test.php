 ...
 *
 * Verifies that Mullion_Asset_Library::sanitize_svg_string() strips
...
class Mullion_SVG_Sanitization_Test extends WP_UnitTestCase {

    /**
     * Helper: sanitize an SVG string and return the result.
     */
    private function sanitize( string $svg ): ?string {
        return Mullion_Asset_Library::sanitize_svg_string( $svg );
    }
    ...
    public function test_sanitize_svg_file_writes_clean_output(): void {
        ...
        $result = Mullion_Asset_Library::sanitize_svg_file( $tmp );

 ...
 * @package Mullion
 */
class Mullion_P63G_Bearer_Auth_Test extends WP_UnitTestCase {
    ...
    public function test_bare_bearer_header_not_honored_by_default() {
        ...
        $this->assertFalse( Mullion_REST_Base::bearer_auth_is_verified( 'Bearer garbage' ) );
    }

    public function test_non_bearer_or_empty_header_not_honored() {
        $this->assertFalse( Mullion_REST_Base::bearer_auth_is_verified( 'Basic abc' ) );
        $this->assertFalse( Mullion_REST_Base::bearer_auth_is_verified( '' ) );
    }
    ...
    public function test_filter_receives_the_header_value() {
        ...
        Mullion_REST_Base::bearer_auth_is_verified( 'Bearer abc123' );

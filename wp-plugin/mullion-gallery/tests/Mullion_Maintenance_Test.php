...
class Mullion_Maintenance_Test extends WP_UnitTestCase {
    ...
    public function test_register_schedules_cron_when_retention_set() {
        ...
        $this->assertNotFalse(wp_next_scheduled(Mullion_Maintenance::CLEANUP_HOOK));
        $this->assertNotFalse(wp_next_scheduled(Mullion_Maintenance::TRASH_PURGE_HOOK));
    }
    ...
    public function test_register_skips_cron_when_retention_zero() {
        ...
        $this->assertFalse(wp_next_scheduled(Mullion_Maintenance::CLEANUP_HOOK));
    }
    ...
    public function test_trash_moves_old_archived_campaigns_to_trash() {
        ...
        Mullion_Maintenance::trash_archived_campaigns();
    ...
    public function test_purge_trashed_deletes_campaigns_past_grace_period() {
        ...
        Mullion_Maintenance::purge_trashed_campaigns();

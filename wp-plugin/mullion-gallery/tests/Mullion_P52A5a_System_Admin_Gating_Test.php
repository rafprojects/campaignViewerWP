 ...
 */
class Mullion_P52A5a_System_Admin_Gating_Test extends WP_UnitTestCase {
    ...
    public function test_require_system_admin_primitive() {
        $this->make_editor();
        $this->assertFalse(Mullion_REST_Base::require_system_admin(), 'editor fails require_system_admin');

        $this->make_system_admin();
        $this->assertTrue(Mullion_REST_Base::require_system_admin() === true, 'admin passes require_system_admin');
    }
}

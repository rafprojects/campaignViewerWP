...
class Mullion_P28O_Campaign_Templates_Test extends WP_UnitTestCase {
    ...
    public function test_instantiate_user_template_creates_campaign() {
        ...
        $this->assertEmpty(get_post_meta((int) $data['id'], Mullion_Campaign_Templates::META_IS_TEMPLATE, true));

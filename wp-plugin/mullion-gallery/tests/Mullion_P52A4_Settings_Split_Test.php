 ...
 */
class Mullion_P52A4_Settings_Split_Test extends WP_UnitTestCase {
    ...
    public function test_editor_cannot_write_system_setting_via_post() {
        $before = Mullion_Settings::get_settings()['cache_ttl'];
        $this->set_editor();
    ...
    public function test_editor_mixed_payload_is_rejected_atomically() {
        $theme_before = Mullion_Settings::get_settings()['theme'] ?? '';
        $this->set_editor();
    ...
    public function test_system_admin_can_write_system_setting() {
        ...
        $this->assertSame(777, Mullion_Settings::get_settings()['cache_ttl']);
    }
}

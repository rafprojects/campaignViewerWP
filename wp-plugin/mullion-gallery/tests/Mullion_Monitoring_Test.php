...
class Mullion_Monitoring_Test extends WP_UnitTestCase {
    ...
    public function test_start_timer_ignores_non_wpsg_routes() {
        ...
        Mullion_Monitoring::start_timer(null, $server, $request);
    ...
    public function test_log_fatal_error_fires_action_on_fatal() {
        ...
        Mullion_Monitoring::log_fatal_error();
    ...
    public function test_track_oembed_failure_records_provider() {
        Mullion_Monitoring::track_oembed_failure('https://www.youtube.com/watch?v=abc', ['endpoint1']);
    ...
    public function test_track_oembed_failure_increments_count() {
        Mullion_Monitoring::track_oembed_failure('https://vimeo.com/123', ['ep1']);
        Mullion_Monitoring::track_oembed_failure('https://vimeo.com/456', ['ep2']);
    ...
    public function test_track_oembed_failure_stores_recent_timestamps() {
        for ($i = 0; $i < 12; $i++) {
            Mullion_Monitoring::track_oembed_failure('https://rumble.com/v' . $i, ['ep']);
        }
    ...
    public function test_track_oembed_failure_detects_providers() {
        ...
        foreach ($providers as $url => $expected) {
            Mullion_Monitoring::track_oembed_failure($url, ['ep']);
        }
    ...
    public function test_track_oembed_failure_unknown_provider() {
        Mullion_Monitoring::track_oembed_failure('https://example.com/media/1', ['ep']);
    ...
    public function test_reset_oembed_failures_clears_all() {
        Mullion_Monitoring::track_oembed_failure('https://youtube.com/v1', ['ep']);
        Mullion_Monitoring::track_oembed_failure('https://vimeo.com/1', ['ep']);

        Mullion_Monitoring::reset_oembed_failures();
    ...
    public function test_reset_oembed_failures_clears_single_provider() {
        ...
        Mullion_Monitoring::reset_oembed_failures('youtube');
    ...
    public function test_get_health_data_returns_expected_keys() {
        $data = Mullion_Monitoring::get_health_data();

...
class Mullion_Campaign_Rest_Test extends WP_UnitTestCase {
    ...
    public function test_sanitize_visibility_whitelists_values() {
        ...
        $this->assertEquals( 'private', Mullion_CPT::sanitize_visibility( 'evil_visibility' ) );
        $this->assertEquals( 'private', Mullion_CPT::sanitize_visibility( '<script>alert(1)</script>' ) );
    }
    ...
    public function test_sanitize_status_whitelists_values() {
        ...
        $this->assertEquals( 'draft', Mullion_CPT::sanitize_status( 'malicious' ) );
    }
    ...
    public function test_sanitize_media_items_sanitizes_urls() {
        ...
        $result = Mullion_CPT::sanitize_media_items( $input );
    ...
    public function test_sanitize_tags_strips_html() {
        ...
        $result = Mullion_CPT::sanitize_tags( $input );
    ...
    public function test_sanitize_datetime_accepts_valid_iso8601() {
        $this->assertEquals( '2026-03-05 14:30:00', Mullion_CPT::sanitize_datetime( '2026-03-05T14:30:00' ) );
        $this->assertEquals( '2026-03-05 09:00:00', Mullion_CPT::sanitize_datetime( '2026-03-05T14:30:00+05:30' ) );
        $this->assertEquals( '2026-03-05 14:30:00', Mullion_CPT::sanitize_datetime( '2026-03-05T14:30:00Z' ) );
        $this->assertEquals( '2026-03-05 14:30:00', Mullion_CPT::sanitize_datetime( '2026-03-05 14:30:00' ) );
    }
    ...
    public function test_sanitize_datetime_rejects_invalid_format() {
        $this->assertEquals( '', Mullion_CPT::sanitize_datetime( 'not-a-date' ) );
        $this->assertEquals( '', Mullion_CPT::sanitize_datetime( '03/05/2026' ) );
        $this->assertEquals( '', Mullion_CPT::sanitize_datetime( '<script>alert(1)</script>' ) );
    }
    ...
    public function test_sanitize_datetime_accepts_empty_string() {
        $this->assertEquals( '', Mullion_CPT::sanitize_datetime( '' ) );
    }
    ...
    public function test_delete_campaign_happy_path_removes_post_and_meta() {
        ...
        global $wpdb;
        $refs_table = Mullion_DB::get_media_refs_table();

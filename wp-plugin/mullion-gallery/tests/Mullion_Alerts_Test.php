...
class Mullion_Alerts_Test extends WP_UnitTestCase {
    ...
    public function setUp(): void {
        parent::setUp();
        delete_option(Mullion_Alerts::EMAIL_QUEUE);
    ...
    private function flush_email_queue(): void {
        if (!defined('DISABLE_WP_CRON') || !DISABLE_WP_CRON) {
            Mullion_Alerts::process_email_queue();
        }
    }
    ...
    public function test_notify_fatal_error_queues_email() {
        ...
        Mullion_Alerts::notify_fatal_error($payload);
    ...
    public function test_track_rest_metrics_ignores_non_500_errors() {
        Mullion_Alerts::track_rest_metrics(['status' => 404, 'route' => '/test']);

        $bucket = get_transient(Mullion_Alerts::REST_ERROR_BUCKET);
    ...
    public function test_process_email_queue_sends_and_clears() {
        ...
        update_option(Mullion_Alerts::EMAIL_QUEUE, [
            [
        ...
        $remaining = get_option(Mullion_Alerts::EMAIL_QUEUE, 'deleted');
    ...
    public function test_email_queue_cap_behavior() {
        ...
        Mullion_Alerts::notify_fatal_error(['type' => E_ERROR, 'message' => 'cap_test', 'file' => 'x', 'line' => 1]);
        Mullion_Alerts::notify_fatal_error(['type' => E_ERROR, 'message' => 'cap_test2', 'file' => 'x', 'line' => 2]);
    ...
    public function test_custom_recipient_used() {
        ...
        Mullion_Alerts::notify_fatal_error(['type' => E_ERROR, 'message' => 'test', 'file' => 'f', 'line' => 1]);

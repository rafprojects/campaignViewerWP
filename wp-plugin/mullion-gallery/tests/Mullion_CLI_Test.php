<?php
/**
 * PHPUnit tests for Mullion_CLI command class.
 *
...
require_once __DIR__ . '/../includes/class-mullion-cli.php';

/**
 * @covers Mullion_CLI
 */
class Mullion_CLI_Test extends WP_UnitTestCase {

    private Mullion_CLI $cli;

    public function setUp(): void {
        parent::setUp();
        WP_CLI::reset();
        WP_CLI_Utils_Stub::reset();
        $this->cli = new Mullion_CLI();
    }
    ...
    public function test_campaign_duplicate_can_duplicate_layout_template(): void {
        ...
        $template = Mullion_Layout_Templates::create( [
            'name'              => 'CLI Layout',
    ...
    public function test_campaign_export_import_round_trip(): void {
        ...
        $tpl = Mullion_Layout_Templates::create( [
    ...
    public function test_cache_clear_calls_thumbnail_cache(): void {
        // Mullion_Thumbnail_Cache::clear_all() returns an integer count.
    ...
    public function test_cli_class_is_loadable_when_wp_cli_is_defined(): void {
        $this->assertTrue( class_exists( 'Mullion_CLI' ), 'Mullion_CLI class must exist' );
    }

    /**
     * Verify Mullion_CLI is NOT auto-loaded without explicit require by checking
    ...
    public function test_archive_writes_audit_entry(): void {
        ...
        $result = Mullion_DB::list_audit_entries( [ 'campaign_id' => $id ] );
    ...
    public function test_duplicate_writes_audit_entry_on_new_campaign(): void {
        ...
        $result = Mullion_DB::list_audit_entries( [ 'campaign_id' => $new_id ] );
        $events = array_column( $result['items'], 'action' );

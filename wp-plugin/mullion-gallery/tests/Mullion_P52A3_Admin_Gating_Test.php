...
class Mullion_P52A3_Admin_Gating_Test extends WP_UnitTestCase {
    ...
    public function test_spaces_admin_page_registered_with_manage_options() {
        ...
        Mullion_Space_Admin_Renderer::add_menu_page();

        $this->assertSame(
            'manage_options',
            $this->submenu_capability(Mullion_Space_Admin_Renderer::PAGE_SLUG),
    ...
    public function test_settings_admin_page_remains_manage_options() {
        ...
        $this->assertSame(
            'manage_options',
            $this->submenu_capability(Mullion_Settings::PAGE_SLUG),
    ...
    public function test_create_space_handler_denies_editor() {
        ...
        Mullion_CPT::handle_create_space();
    }
}

 ...
 */
class Mullion_Coverage_Extras_Test extends WP_UnitTestCase {
    ...
    public function test_sentry_capture_message_without_sentry_is_noop() {
        ...
        Mullion_Sentry::capture_message('test message', ['key' => 'value']);
        $this->assertTrue(true);
    }

    // ═══════════════════════════════════════════════════════════════════════
    // Mullion_OEmbed_Providers
    // ═══════════════════════════════════════════════════════════════════════

    public function test_oembed_providers_fetch_delegates_to_registry() {
        $attempts = [];
        // Use a URL that won't match any provider.
        $result = Mullion_OEmbed_Providers::fetch(
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Mullion_Embed — register_shortcode, register_assets, add_asset_cache_headers
    // ═══════════════════════════════════════════════════════════════════════
    ...
    public function test_embed_register_shortcode() {
        ...
        Mullion_Embed::register_shortcode();
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Mullion_Asset_Library — ensure_htaccess, sanitize_svg_uris
    // ═══════════════════════════════════════════════════════════════════════
    ...
    public function test_ensure_htaccess_creates_file() {
        ...
        Mullion_Asset_Library::ensure_htaccess($test_dir);
    ...
    public function test_sanitize_svg_uris_blocks_javascript() {
        ...
        $result = Mullion_Asset_Library::sanitize_svg_uris($svg);
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Mullion_Thumbnail_Cache — register, refresh_all
    // ═══════════════════════════════════════════════════════════════════════

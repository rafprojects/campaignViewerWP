 ...
 */
class Mullion_P50A_Campaign_Move_Test extends WP_UnitTestCase {
    ...
    private function move_tables(): array {
        return [
            ...
            Mullion_DB::get_audit_log_table(),
            Mullion_DB::get_media_refs_table(),
    ...
    private function seed_campaign_rows(int $campaign_id, int $space_id): void {
        ...
        $wpdb->insert(Mullion_DB::get_audit_log_table(), [
            'campaign_id' => $campaign_id,
            'action'      => 'p50a.seed',
            'details'     => '{}',
            'created_at'  => $now,
        ...
        $wpdb->insert(Mullion_DB::get_media_refs_table(), [
        ...
        $wpdb->insert(Mullion_DB::get_access_requests_table(), [
    ...
    public function test_move_to_archived_space_is_rejected() {
        ...
        Mullion_DB::archive_space($space_b);

 ...
 */
class Mullion_P40_CT1_Event_Contract_Test extends WP_UnitTestCase {
    ...
    private function insert(int $campaign_id, string $action, array $extra = []): void {
        Mullion_DB::insert_audit_entry(array_merge([
    ...
    public function test_insert_and_format_round_trip_new_fields() {
        ...
        $result = Mullion_DB::list_audit_entries(['campaign_id' => $campaign_id]);
    ...
    public function test_list_filters_by_scope() {
        ...
        $campaign_only = Mullion_DB::list_audit_entries(['scope' => 'campaign']);
        ...
        $system_only = Mullion_DB::list_audit_entries(['scope' => 'system']);
    ...
    public function test_list_filters_by_severity() {
        ...
        $info_only = Mullion_DB::list_audit_entries(['campaign_id' => $campaign_id, 'severity' => 'info']);
        ...
        $warning_only = Mullion_DB::list_audit_entries(['campaign_id' => $campaign_id, 'severity' => 'warning']);

 ...
 * @package Mullion
 */
class Mullion_P63E_Export_Job_Tier_Test extends WP_UnitTestCase {
    ...
    public function test_create_job_stamps_creator_and_required_tier() {
        ...
        $this->assertSame( Mullion_Permissions::TIER_SYSTEM_ADMIN, $job['required_tier'] );
    ...
    public function test_create_job_defaults_to_editor_tier() {
        ...
        $this->assertSame( Mullion_Permissions::TIER_EDITOR, $job['required_tier'] );

        Mullion_Export_Engine::delete_job( $id );
    }

    public function test_invalid_required_tier_falls_back_to_editor() {
        $id  = Mullion_Export_Engine::create_job( 'campaign', '{}', [], required_tier: 'nonsense' );
        $job = Mullion_Export_Engine::get_job( $id );
    ...
    public function test_system_admin_can_access_another_users_job() {
        wp_set_current_user( $this->editor_id );
        $id = Mullion_Export_Engine::create_job( 'campaign', '{}', [] ); // created by the editor

 ...
 */
class Mullion_P28G_Audit_Log_Test extends WP_UnitTestCase {
    ...
    public function test_audit_date_range_filter() {
        ...
        Mullion_DB::insert_audit_entry(['campaign_id' => $campaign_id, 'action' => 'early.event', 'actor_id' => 1, 'actor_login' => 'admin', 'details' => [], 'created_at' => '2026-01-05 09:00:00']);
    ...
    public function test_audit_action_filter() {
        ...
        Mullion_DB::insert_audit_entry(['campaign_id' => $campaign_id, 'action' => 'media.added', 'actor_id' => 1, 'actor_login' => 'admin', 'details' => [], 'created_at' => '2026-01-01 10:00:00']);
    ...
    public function test_audit_pagination_with_action_filter() {
        ...
        for ($i = 1; $i <= 5; $i++) {
            Mullion_DB::insert_audit_entry(['campaign_id' => $campaign_id, 'action' => 'media.added', 'actor_id' => 1, 'actor_login' => 'admin', 'details' => [], 'created_at' => gmdate('Y-m-d H:i:s', strtotime("2026-01-0{$i} 10:00:00"))]);
        }

 ...
 * @package Mullion
 */
class Mullion_P63I_Export_Job_Space_Test extends WP_UnitTestCase {
    ...
    public function test_create_job_stamps_and_dedups_space_ids() {
        ...
        $id  = Mullion_Export_Engine::create_job( 'multi_campaign', '{}', [], space_ids: [ $a, $b, $a ] );
    ...
    public function test_create_job_drops_non_positive_space_ids() {
        $a   = $this->make_space();
        $id  = Mullion_Export_Engine::create_job( 'campaign', '{}', [], space_ids: [ $a, 0, -3 ] );
        $job = Mullion_Export_Engine::get_job( $id );
    ...
    public function test_batch_requires_access_to_all_spaces() {
        ...
        wp_set_current_user( $editor );
        $id = Mullion_Export_Engine::create_job( 'multi_campaign', '{}', [], space_ids: [ $a, $b ] );

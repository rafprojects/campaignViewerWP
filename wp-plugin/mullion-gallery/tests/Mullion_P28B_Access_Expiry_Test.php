 ...
 *  - Mullion_Maintenance::purge_expired_grants() removes stale entries.
 *  - Invalid expires_at format returns 400.
 *  - Grant with no expires_at is permanent (is_expired = false).
 */
class Mullion_P28B_Access_Expiry_Test extends WP_UnitTestCase {
    ...
    public function test_purge_expired_grants_removes_past_expiry_entries() {
        ...
        Mullion_Maintenance::purge_expired_grants();

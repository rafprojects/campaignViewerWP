 ...
 *  - Mullion_Font_Library::set_universal() round-trips and get_all() reflects it;
 ...
 */
class Mullion_P50J_Font_Universal_Test extends WP_UnitTestCase {

    public function tear_down(): void {
        delete_option( Mullion_Font_Library::OPTION_KEY );
        parent::tear_down();
    }
    ...
    private function font_is_universal(string $id): bool {
        foreach ( Mullion_Font_Library::get_all() as $item ) {
            if ( ($item['id'] ?? '') === $id ) {
    ...
    public function test_set_universal_round_trip() {
        ...
        $this->assertTrue(Mullion_Font_Library::set_universal($id, true));
        $this->assertTrue($this->font_is_universal($id), 'Should now be universal.');

        $this->assertTrue(Mullion_Font_Library::set_universal($id, false));
    ...
    public function test_set_universal_unknown_font_returns_false() {
        $this->set_super_admin();
        $this->assertFalse(Mullion_Font_Library::set_universal('00000000-0000-0000-0000-000000000000', true));
    }

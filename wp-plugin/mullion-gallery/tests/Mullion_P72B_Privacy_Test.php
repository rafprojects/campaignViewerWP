 ...
 */
class Mullion_P72B_Privacy_Test extends WP_UnitTestCase {
    ...
    public function test_export_access_requests_returns_matching_rows() {
        ...
        $result = Mullion_Privacy::export_access_requests('subject@example.com');
    ...
    public function test_erase_access_requests_removes_only_the_subject_rows() {
        ...
        $result = Mullion_Privacy::erase_access_requests('subject@example.com');

        $this->assertTrue($result['items_removed']);
        $this->assertTrue($result['done']);

        // The subject's row is gone; the other email's row remains.
        $this->assertCount(0, Mullion_DB::get_access_requests_by_email('subject@example.com', 100, 0));
        $this->assertCount(1, Mullion_DB::get_access_requests_by_email('someone-else@example.com', 100, 0));
    }

    public function test_erase_access_requests_reports_nothing_removed_for_unknown_email() {
        $result = Mullion_Privacy::erase_access_requests('nobody@example.com');
    ...
    public function test_export_audit_log_returns_rows_for_the_matching_user() {
        ...
        $result = Mullion_Privacy::export_audit_log('staff@example.com');
    ...
    public function test_export_audit_log_matches_by_actor_login_when_id_absent() {
        ...
        $result = Mullion_Privacy::export_audit_log('legacy@example.com');
    ...
    public function test_export_audit_log_empty_for_email_with_no_user() {
        ...
        $result = Mullion_Privacy::export_audit_log('no-such-user@example.com');

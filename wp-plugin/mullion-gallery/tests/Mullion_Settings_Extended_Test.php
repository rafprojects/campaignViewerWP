 ...
 * (Mullion_Settings_Core_Fields, Mullion_Settings_Renderer) directly; the facade no
 * longer proxies those rendering concerns.
 */
class Mullion_Settings_Extended_Test extends WP_UnitTestCase {

    // ── snake_to_camel ─────────────────────────────────────────────────────

    public function test_snake_to_camel_basic() {
        $this->assertEquals('videoViewportHeight', Mullion_Settings_Utils::snake_to_camel('video_viewport_height'));
    }

    public function test_snake_to_camel_single_word() {
        $this->assertEquals('theme', Mullion_Settings_Utils::snake_to_camel('theme'));
    }

    public function test_snake_to_camel_two_words() {
        $this->assertEquals('authProvider', Mullion_Settings_Utils::snake_to_camel('auth_provider'));
    }
    ...
    public function test_get_setting_returns_default_for_missing() {
        $val = Mullion_Settings::get_setting('nonexistent_key_xyz', 'fallback');
    ...
    public function test_to_js_returns_camel_case_keys() {
        $settings = Mullion_Settings::get_settings();
        $js = Mullion_Settings::to_js($settings, true);
    ...
    public function test_to_js_excludes_admin_fields_when_not_admin() {
        $settings = Mullion_Settings::get_settings();
        $public = Mullion_Settings::to_js($settings, false);
        $admin = Mullion_Settings::to_js($settings, true);
    ...
    public function test_from_js_converts_camel_to_snake() {
        ...
        $result = Mullion_Settings::from_js($body);
    ...
    public function test_get_settings_merges_with_defaults() {
        ...
        $nested_only_keys = array_fill_keys(
            Mullion_Settings_Sanitizer::get_nested_only_gallery_setting_keys(),
            true
        );
    ...
    public function test_sanitize_settings_rejects_invalid_auth_provider() {
        $result = Mullion_Settings::sanitize_settings(['auth_provider' => 'hacked']);
    ...
    public function test_sanitize_settings_sanitizes_numeric_fields() {
        $result = Mullion_Settings::sanitize_settings([
    ...
    public function test_render_settings_page_outputs_form() {
        ...
        ob_start();
        Mullion_Settings_Renderer::render_settings_page();
        $html = ob_get_clean();

 ...
 */
class Mullion_P66B_Archived_At_Backfill_Test extends WP_UnitTestCase {

    public function setUp(): void {
        // DDL before the WP transaction (see Mullion_P28H_Analytics_Test rationale).
    ...
    private function run_backfill(): void {
        $method = new ReflectionMethod('Mullion_DB', 'maybe_backfill_archived_at');

...
class Mullion_Image_Optimizer_Test extends WP_UnitTestCase {
    ...
    public function test_optimize_on_upload_skips_non_images() {
        ...
        $result = Mullion_Image_Optimizer::optimize_on_upload($upload, 'upload');
    ...
    public function test_skip_resize_preserves_large_image_dimensions() {
        ...
        Mullion_Image_Optimizer::optimize_on_upload([
            'file' => $file,
    ...
    public function test_constrain_image_returns_true_for_small_image() {
        ...
        $result = Mullion_Image_Optimizer::constrain_image($file, 1920, 1920, 82);
    ...
    public function test_constrain_image_returns_wp_error_for_invalid_file() {
        $result = Mullion_Image_Optimizer::constrain_image('/tmp/nonexistent-' . uniqid(), 1920, 1920, 82);
    ...
    public function test_generate_webp_creates_webp_file() {
        ...
        $result = Mullion_Image_Optimizer::generate_webp($file, 82);
    ...
    public function test_generate_webp_returns_wp_error_for_invalid_file() {
        $result = Mullion_Image_Optimizer::generate_webp('/tmp/nonexistent-' . uniqid(), 82);
        $this->assertInstanceOf(WP_Error::class, $result);
    }
    ...
    public function test_add_webp_mime_adds_webp_type() {
        $mimes = Mullion_Image_Optimizer::add_webp_mime([]);
    ...
    public function test_add_webp_mime_preserves_existing_mimes() {
        $mimes = Mullion_Image_Optimizer::add_webp_mime(['jpg' => 'image/jpeg']);
    ...
    public function test_default_constants() {
        $this->assertEquals(1920, Mullion_Image_Optimizer::MAX_WIDTH_DEFAULT);
        $this->assertEquals(1920, Mullion_Image_Optimizer::MAX_HEIGHT_DEFAULT);
        $this->assertEquals(82, Mullion_Image_Optimizer::QUALITY_DEFAULT);
    }

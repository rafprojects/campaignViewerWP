 ...
 *
 * Unit-tests the Mullion_Campaign_Controller::csv_cell() helper (via reflection)
 ...
 * @package Mullion
 */
class Mullion_P63D_Audit_Csv_Injection_Test extends WP_UnitTestCase {

    private function cell( $value ): string {
        $m = new ReflectionMethod( Mullion_Campaign_Controller::class, 'csv_cell' );

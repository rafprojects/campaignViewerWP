...
class WPSG_P52A_Permission_Matrix_Test extends WP_UnitTestCase {
    ...
    private function expected_matrix(): array {
        return [
            ...
            'analytics.summary.read'                => 'require_admin',
            // Auth
            ...
            'roles.list'                            => 'require_admin',
            // Access
            'campaigns.access_summary.read'         => 'require_admin',
            'campaign.access.list'                  => 'require_campaign_owner',
            'campaign.access.grant'                 => 'require_campaign_owner',
            'campaign.access.revoke'                => 'require_campaign_owner',
            'campaign.access_request.submit'        => 'rate_limit_public',
            'campaign.access_request.list'          => 'require_campaign_owner',
            'campaign.access_request.approve'       => 'require_campaign_owner',
            'campaign.access_request.deny'          => 'require_campaign_owner',
            'campaign.access_request.magic_approve' => 'rate_limit_magic_approve',
            'company.access.list'                   => 'require_admin',
            'company.access.grant'                  => 'require_admin',
            'company.access.revoke'                 => 'require_admin',
            'company.archive'                       => 'require_admin',
            // Media
            'media.usage_summary.read'              => 'require_admin',
            'media.usage.read'                      => 'require_admin',
            'campaign.media.list'                   => 'rate_limit_public',
            'campaign.media.create'                 => 'require_campaign_editor',
            'campaign.media.create_batch'           => 'require_campaign_editor',
            'campaign.media.reorder'                => 'require_campaign_editor',
            'campaign.media.rescan'                 => 'require_campaign_editor',
            'campaign.media.update'                 => 'require_campaign_editor',
            'campaign.media.delete'                 => 'require_campaign_editor',
            'media.rescan_all'                      => 'require_admin',
            'media.library.list'                    => 'require_admin',
            'media.upload'                          => 'require_admin',
            'media_tags.list'                       => 'require_admin',
            'media_tags.create'                     => 'require_admin',
            'media_tags.delete'                     => 'require_admin',
            'media.export_binary'                   => 'require_admin',
            'media.import_binary'                   => 'require_admin',
            // Content
            ...
            'campaigns.import'                      => 'require_admin',
            'campaign.export_binary'                => 'require_admin',
            'campaigns.import_binary'               => 'require_admin',
            ...
            'system.health.read'                    => 'require_admin',
            'system.oembed_failures.read'           => 'require_admin',
            'system.oembed_failures.reset'          => 'require_admin',
            'system.thumbnail_cache.read'           => 'require_admin',
            'system.thumbnail_cache.clear'          => 'require_admin',
            'system.thumbnail_cache.refresh'        => 'require_admin',
            'webhooks.list'                         => 'require_admin',
            'webhooks.create'                       => 'require_admin',
            'webhooks.delivery_log.read'            => 'require_admin',
            'webhooks.update'                       => 'require_admin',
            'webhooks.delete'                       => 'require_admin',
            'webhooks.rotate_secret'                => 'require_admin',
            // Space
            'spaces.list'                           => 'require_admin',
            'spaces.create'                         => 'require_admin',
            'space.read'                            => 'require_space_member',
            'space.update'                          => 'require_space_owner',
            'space.delete'                          => 'require_space_owner',
            'space.access.list'                     => 'require_space_owner',
            'space.access.grant'                    => 'require_space_owner',
            'space.access.revoke'                   => 'require_space_owner',
            'space.resolve_user'                    => 'require_space_owner',
            'space.settings.read'                   => 'require_space_member',
            'space.settings.update'                 => 'require_space_owner',
            'space.library.read'                    => 'require_space_member',
            'space.library.associate'               => 'require_space_owner',
            'space.library.dissociate'              => 'require_space_owner',
            // Campaign
            'campaigns.list'                        => 'rate_limit_public',
            'campaigns.create'                      => 'require_admin',
            'campaign.read'                         => 'rate_limit_public',
            'campaign.update'                       => 'require_campaign_editor',
            'campaign.delete'                       => 'require_campaign_owner',
            'campaign.archive'                      => 'require_campaign_owner',
            ...
            'system.audit_log.read'                 => 'require_admin',
            'system.audit_log.export_binary'        => 'require_admin',
        ];
    }
